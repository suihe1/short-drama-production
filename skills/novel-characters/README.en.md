...
scripts/
  ...
  selftest.mjs           310 assertions, never calls a model
references/
...
310 assertions across chunking, alias merging, assembly, localization, validation, and rendering. No model calls, no quota, runs in about a second. Run it before anything else after touching the scripts.
